...
function Order(props) {
  ...
  useEffect(() => {
    settotalPrice(selections.length * selectionPrice + count * 85.5);
  }, [selections, count]);
  ...
  useEffect(() => {
    ...
    .post("https://reqres.in/api/users", formData2)
      /* .patch("https://reqres.in/api/users",formData2)
            ...
            <Form onSubmit={handleSubmit}>
              <div className="pizzaSize">
                <FormGroup>
                  ...
                  {formData.boyutSec == "" && (
                    <p className="hata">Pizza boyutunu seçmelisiniz.</p>
                  )}
                  <div>
                    <Input
                      id="kucukBoy"
                ...
                <FormGroup>
                  <Label className="hamurSec" for="hamurSec">
                    Hamur Seç *
                  </Label>
                  <br />
                  {formData.hamurSec == "" && (
                    <p className="hata">Pizza hamurunu seçmelisiniz.</p>
                  )}
                  <Input
                    id="hamurSec"
                    name="hamurSec"
              ...
              <FormGroup className="ekMalzeme">
                ...
                />
                {selections.length < 4 && (
                  <p className="hata">En az 4 malzeme seçmelisiniz.</p>
                )}
                {selections.length > 10 && (
                  <p className="hata">
                    En fazla 10 malzeme seçebilirsiniz. Her seçim 5₺
                  </p>
                )}
              </FormGroup>
              <br />
              ...
              <div className="order-confirm">
                <div className="complex-buttons">
                  ...
                  <button className="count" disabled>
                    {count}
                  </button>
                  <button onClick={(e) => setOrder(e, 1)}>+</button>
                </div>
                <div className="order-summary">
                    ...
                    <div className="value-group">
                      <div>
                        ...
                        <div className="value-b">
                          {selections.length * selectionPrice}
                        </div>
                      </div>
                      <div>
                  ...
                  <Link to="/soru">
                    <button
                      ...
                      className="siparis-ver" /* disabled={!isValid} */
                    >
                      SİPARİŞ VER
                    </button>
                  </Link>
